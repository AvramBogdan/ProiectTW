<?php
  ...
  $user_city = (auth()->check()) ? auth()->user()->city: null;
  $user_email = (auth()->check()) ? auth()->user()->email: null;
  $username = (auth()->check()) ? auth()->user()->name: null;

  Session::put('loginCity',$user_city);
  Session::put('loginEmail',$user_email);
  Session::put('loginUser',$username);
  

 $dom = new DomDocument(); 
 $dom -> load('http://api.openweathermap.org/data/2.5/forecast/?q='.$user_city.'&mode=xml&APPID=a905f842072c2551a3b846b96e48a6d5');
...
<div class="container">
    <div class="row">
      ...
      <div class="weather" style="margin-left: -130px">                 
        <div class="weather-customize" > 
          <div class="booked-weather-custom-160 color-137AE9" style="width:250px; " id="width3"> 
            ...
            <div class="booked-weather-custom-160-main more"> 
              ...
              <div class="booked-weather-custom-160-degree booked-weather-custom-C wmd10">
                <span class="bb"><span class="plus"></span>
              ...
              <div class="booked-weather-custom-160-main more" >  
                ...
                <div class="booked-weather-custom-160-degree booked-weather-custom-C wmd14" >
                  <span class="bb"><span class="plus " ></span>
    ...
    <!--[if lte IE 9]><script type="text/javascript" src="cssslider_files/csss_engine1/ie.js"></script><![endif]-->
     <div class="csslider1 autoplay slider">
